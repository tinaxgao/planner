...
import { LIST, LISTITEM, SUBLIST } from "../../components/constants";

const ACCEPTS = [LIST, LISTITEM, SUBLIST];

const DropZone = ({ data, onDrop, isFirst, className }) => {
